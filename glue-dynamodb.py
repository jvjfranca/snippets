...
dynamodb_table_1 = glueContext.create_dynamic_frame.from_options(
    "dynamodb",
    {
...
dynamodb_table_2 = glueContext.create_dynamic_frame.from_options(
    "dynamodb",
    {
...
s3_bucket_1 = glueContext.create_dynamic_frame.from_options(
    "s3",
    {
...
joined_data = Join.apply(s3_bucket_1, dynamodb_table_1, "s3_key", "dynamodb_1_key").join(
    dynamodb_table_2, "dynamodb_2_key", "dynamodb_2_key")
